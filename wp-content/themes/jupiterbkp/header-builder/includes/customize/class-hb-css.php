...
class HB_CSS {
	 ...
	 */
	public function background( array $layers = array(), $css = '' ) {
		$css = '';
		...
		if ( ! empty( $auto_prefix['sizes'] ) ) {
			...
			$css .= 'background-repeat: ' . implode( ', ', $auto_prefix['repeats'] ) . ";\n";
			$css .= 'background-position: ' . implode( ', ', $auto_prefix['positions'] ) . ";\n";
