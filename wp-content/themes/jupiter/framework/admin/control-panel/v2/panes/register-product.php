...
<div class="mka-cp-pane-box" id="mk-cp-register-product">
    ...
    <ul class="mka-cp-register-steps">
    	<ol>
    		<li><?php printf(__( '%sSign up%s to %sArtbees Themes Portal%s', 'mk_framework' ), 
                '<a target="_blank" href="https://themes.artbees.net/sign-up/">','</a>','<strong>','</strong>'); ?>.</li>
			<li><?php printf(__( 'Generate an API Key. Get your %spurchase code%s from themeforest and enter it in your dashboard in %sArtbees Themes website%s', 'mk_framework' ), 
                '<a target="_blank" href="https://themeforest.net/downloads">','</a>','<a href="https://themes.artbees.net/">','</a>'); ?>.</li>
			<li><?php printf(__( 'Register your %sAPI Key%s. Enter your API key in the field below. All set!', 'mk_framework' ), 
                '<a target="_blank" href="https://themes.artbees.net/dashboard/register-product/">','</a>'); ?></li>
    	</ol>
    </ul>

    <div class="mka-cp-register-api register-product-form <?php echo $has_api_key; ?>">
    ...
    <div class="mka-cp-revoke-api register-product-form <?php echo $no_api_key; ?>">
        <span class="mka-cp-register-api-label"><?php esc_html_e( 'Artbees Api Key', 'mk_framework' ); ?></span>
        <div class="mka-cp-api-key-text"><?php echo $api_key; ?></div>
    ...
    <div class="mka-fsize-14"><?php esc_html_e( 'Any problem?', 'mk_framework' ); ?> <a target="_blank" href="https://www.youtube.com/watch?v=I9FERyjuq4A"><?php esc_html_e( 'View the tutorial here', 'mk_framework' ); ?></a></div><br>
    <iframe width="400" height="225" src="https://www.youtube.com/embed/I9FERyjuq4A?rel=0&amp;showinfo=0" frameborder="0" allowfullscreen></iframe><br><br><br>
